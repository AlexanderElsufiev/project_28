...
from .tasks import send_notifications2
...
def notify_about_new_post(sender,instance,**kwargs):
    ...
    if kwargs['action']== 'post_add': #если было событие добавления add поста post в категриии PostCategory
        ...
        send_notifications2.delay(instance.preview(), instance.pk, instance.zagolov, subscribers_emails)
        print('ЗАКОНЧЕНА РАСПЕЧАТКА ПОЧТЫ, ЕСЛИ ОНА БЫЛА НУЖНА')
